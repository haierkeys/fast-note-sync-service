...
var (
	...
	ErrorFileDeleteFailed                   = NewError(incr(400), lang{zh: "删除文件失败", en: "Delete file failed"})
	ErrorFileCreateFailed                   = NewError(incr(400), lang{zh: "创建文件失败", en: "Create file failed"})
	ErrorFileModifyFailed                   = NewError(incr(400), lang{zh: "修改文件失败", en: "Modify file failed"})
