...
func (qb *cloudConfigRepoQueryBuilder) WhereEndpoint(p model.Predicate, value string) *cloudConfigRepoQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
		fmt.Sprintf("%v %v ?", "endpoint", p),
		value,
	})
	return qb
}

func (qb *cloudConfigRepoQueryBuilder) WhereEndpointIn(value []string) *cloudConfigRepoQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
		fmt.Sprintf("%v %v ?", "endpoint", "IN"),
		value,
	})
	return qb
}

func (qb *cloudConfigRepoQueryBuilder) WhereEndpointNotIn(value []string) *cloudConfigRepoQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
		fmt.Sprintf("%v %v ?", "endpoint", "NOT IN"),
		value,
	})
	return qb
}

func (qb *cloudConfigRepoQueryBuilder) OrderByEndpoint(asc bool) *cloudConfigRepoQueryBuilder {
	order := "DESC"
	if asc {
		order = "ASC"
	}

	qb.order = append(qb.order, "`endpoint` "+order)
	return qb
}

func (qb *cloudConfigRepoQueryBuilder) WhereRegion(p model.Predicate, value string) *cloudConfigRepoQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *cloudConfigRepoQueryBuilder) WhereRegionIn(value []string) *cloudConfigRepoQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *cloudConfigRepoQueryBuilder) WhereRegionNotIn(value []string) *cloudConfigRepoQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *cloudConfigRepoQueryBuilder) OrderByRegion(asc bool) *cloudConfigRepoQueryBuilder {
	order := "DESC"
	if asc {
		order = "ASC"
	}
