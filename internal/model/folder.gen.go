...
type Folder struct {
	...
	Path             string     `gorm:"column:path;index:idx_folder_vault_id_level_path,priority:3;index:idx_folder_vault_id_fid_path,priority:3;index:idx_folder_vault_id_path,priority:2;default:''" json:"path" form:"path"`
