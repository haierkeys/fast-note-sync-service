...
# Fast Note Sync Service - Edge Case Tests
# Critical tests for edge cases and potential bugs
...
# ============================================================================
print_header "SETUP - Create test user and vault"
...
# ============================================================================
print_header "1. MOVE OPERATIONS - Edge Cases"
...
# ============================================================================
print_header "2. REPLACE OPERATIONS - Multiple Matches"

# Create note with repeated content
...
# Test: Replace first only (all=false)
...
# Count remaining 'foo' occurrences
...
# ============================================================================
print_header "3. VERSION HISTORY TRACKING"

# Create a note and edit it multiple times
...
# ============================================================================
print_header "4. FRONTMATTER EDGE CASES"

# Test: Patch frontmatter on note WITHOUT frontmatter
...
# Test: Add nested YAML structure
...
# ============================================================================
print_header "5. LINK INDEXING - Backlinks & Outlinks"

# Create notes with various link formats
...
# Test: Prepend with frontmatter preservation
...
echo "$CONTENT"
# Check frontmatter is still first
...
# Test: createOnly on soft-deleted note
...
echo "Response: $RESPONSE"
# This should either fail or sanitize the path
print_info "Path traversal handling: $(echo "$RESPONSE" | jq -r '.code')"

# ============================================================================
print_header "9. CONCURRENT EDIT SIMULATION"
